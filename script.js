...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (loginForm) {
        ...
        loginForm.addEventListener("submit", function (event) {
            ...
            const standardElement = document.getElementById("studentClass");
            const passwordElement = document.getElementById("password");

            const name = nameElement ? nameElement.value.trim() : "";
            const standard = standardElement ? standardElement.value : "";
    ...
    const savedStandard = localStorage.getItem("studentStandard");
    ...
    const standardDisplay =
        document.getElementById("standardDisplay");

    if (standardDisplay && savedStandard) {
    ...
    const mathDescription =
        document.getElementById("mathDescription");

    if (mathDescription && savedStandard) {
    ...
    const englishDescription =
        document.getElementById("englishDescription");

    if (englishDescription && savedStandard) {
    ...
    const scienceDescription =
        document.getElementById("scienceDescription");

    if (scienceDescription && savedStandard) {
    ...
    const computerDescription =
        document.getElementById("computerDescription");

    if (computerDescription && savedStandard) {
    ...
    const computerStandard =
        document.getElementById("computerStandard");

    const computerLessonTitle =
        document.getElementById("computerLessonTitle");

    const computerLessonText =
        document.getElementById("computerLessonText");

    if (computerStandard && savedStandard) {
    ...
    const englishStandard =
        document.getElementById("englishStandard");

    const englishLessonTitle =
        document.getElementById("englishLessonTitle");

    const englishLessonText =
        document.getElementById("englishLessonText");

    if (englishStandard && savedStandard) {
        ...
        const lessons = {
            ...
            "1": {
                title: "🔤 Alphabet and Simple Words",
                text:
    ...
    const scienceStandardElement =
        document.getElementById("scienceStandard");

    const scienceLessonTitleElement =
        document.getElementById("scienceLessonTitle");

    const scienceLessonTextElement =
        document.getElementById("scienceLessonText");

    if (scienceStandardElement && savedStandard) {
        ...
        const scienceLessons = {
            ...
            "5": {
                title: "🔬 Human Body and Science",
                text:
                    "Explore the human body, ecosystems, energy and scientific thinking."
            }
        };

        if (scienceLessons[savedStandard]) {

            if (scienceLessonTitleElement) {
                scienceLessonTitleElement.textContent =
                    scienceLessons[savedStandard].title;
            }

            if (scienceLessonTextElement) {
                scienceLessonTextElement.textContent =
                    scienceLessons[savedStandard].text;
            }
        }
    }
    ...
    const scienceTopicTitle =
        document.getElementById("scienceTopicTitle");

    const scienceTopicText =
        document.getElementById("scienceTopicText");
    ...
    if (
        ...
        if (topics[savedStandard]) {

            scienceTopicTitle.textContent =
                topics[savedStandard].title;

            scienceTopicText.textContent =
                topics[savedStandard].text;
        }
    }
...
function logoutStudent() {
    ...
    localStorage.removeItem("studentStandard");
...
function startSubject(subject) {
    ...
    else if (subject === "Fun Activities") {
...
let mathScore =
    Number(localStorage.getItem("mathScore")) || 0;
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (
        ...
        quizQuestions =
            eduConnectMathQuestions[savedStandard] ||
            eduConnectMathQuestions["1"];
...
let readingScore =
    Number(
        localStorage.getItem("readingScore")
    ) || 0;
...
let vocabularyScore =
    Number(
        localStorage.getItem("vocabularyScore")
    ) || 0;
...
function showVocabularyScore() {
    ...
    const scoreElement =
        document.getElementById("vocabularyScore");
...
let grammarScore =
    Number(
        localStorage.getItem("grammarScore")
    ) || 0;
...
function showGrammarScore() {
    ...
    const scoreElement =
        document.getElementById("grammarScore");
...
function showEnglishProgress() {
    ...
    const vocabulary =
        document.getElementById("vocabularyProgress");

    const grammar =
        document.getElementById("grammarProgress");

    const total =
        document.getElementById("totalEnglishProgress");
...
function updateDashboardProgress() {
    ...
    const math =
        Number(
            localStorage.getItem("mathScore")
        ) || 0;

    const science =
        Number(
            localStorage.getItem("scienceScore")
        ) || 0;
    ...
    const parts =
        Number(
            localStorage.getItem("computerPartsScore")
        ) || 0;

    const keyboard =
        Number(
            localStorage.getItem("keyboardScore")
        ) || 0;

    const internet =
        Number(
            localStorage.getItem("internetScore")
        ) || 0;

    const safety =
        Number(
            localStorage.getItem("safetyScore")
        ) || 0;

    const gk =
        Number(
            localStorage.getItem("gkScore")
        ) || 0;
